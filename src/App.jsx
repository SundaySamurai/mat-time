...
const CLUBS = [
  ...
  // ---- Waco ----
  {
    ...
    sessions: [
      { day: "Monday", start: "12:00 PM", end: "1:15 PM", type: "class", label: "Daytime" },
      { day: "Monday", start: "6:30 PM", end: "8:00 PM", type: "class", label: "Adult" },
      { day: "Tuesday", start: "6:00 PM", end: "7:00 PM", type: "class", label: "Adult Novice" },
      { day: "Tuesday", start: "7:15 PM", end: "8:30 PM", type: "class", label: "Judo Newaza" },
      { day: "Wednesday", start: "12:00 PM", end: "1:15 PM", type: "class", label: "Daytime" },
      { day: "Wednesday", start: "6:30 PM", end: "8:00 PM", type: "class", label: "Adult" },
      { day: "Thursday", start: "6:00 PM", end: "7:00 PM", type: "class", label: "Adult Novice" },
      { day: "Thursday", start: "7:15 PM", end: "8:30 PM", type: "class", label: "No-Gi Judo" },
      { day: "Friday", start: "6:30 PM", end: "8:00 PM", type: "class", label: "Adult" },
    ],
    notes: "The only dedicated judo club in the Waco area, per their own site. Tiny Judo (ages 4-6) and Kids Judo (ages 7-12) excluded. New schedule effective Aug 31, 2026 — no more Saturday class.",
    verified: "Sep 2026",
  },
  // ---- Houston ----
  {
  ...
  },
  {
    ...
    sessions: [
      ...
      { day: "Wednesday", start: "6:00 PM", end: "7:00 PM", type: "class", instructor: "Sensei Oishi" },
      { day: "Thursday", start: "6:00 PM", end: "7:00 PM", type: "class", instructor: "Andrew Pernambuco & Jeff Summa" },
      { day: "Saturday", start: "1:00 PM", end: "2:00 PM", type: "class", instructor: "Sensei Oishi" },
    ],
    notes: "Judo only — children's classes excluded. Site lists start times only for adult classes; shown here as 1-hour blocks (actual duration not confirmed). Andrew Pernambuco and Jeff Summa alternate teaching Mon/Tue/Thu, which one on which day isn't specified.",
    verified: "Aug 2026",
  },
  {
    id: "kano-martial-arts-nyc",
    city: "New York, NY",
    name: "Kano Martial Arts",
    coach: "",
    ...
    sessions: [
      ...
      { day: "Thursday", start: "7:00 AM", end: "8:00 AM", type: "class", instructor: "Sensei Garry" },
      { day: "Thursday", start: "11:00 AM", end: "12:30 PM", type: "class", instructor: "Sensei Garry" },
      { day: "Thursday", start: "6:30 PM", end: "8:00 PM", type: "class", instructor: "Sensei Garry" },
      { day: "Saturday", start: "9:30 AM", end: "11:00 AM", type: "class", label: "Basics", instructor: "Sensei Pedro" },
    ],
    notes: "Judo only — their No-Gi Grappling, BJJ, mixed \"GI (Judo + BJJ)\" classes, and Kano Kids excluded. The source schedule screenshot was cut off at the bottom, so additional evening sessions on some days may be missing.",
    verified: "Aug 2026",
  },
  // ---- Glenville, NY ----
  {
    id: "jason-morris-judo-center",
    city: "Glenville, NY",
    name: "Jason Morris Judo Center",
    coach: "",
    ...
    sessions: [
      ...
      { day: "Tuesday", start: "6:30 PM", end: "8:30 PM", type: "class", label: "Adult" },
      { day: "Wednesday", start: "6:30 PM", end: "8:30 PM", type: "class", label: "Adult" },
      { day: "Thursday", start: "6:30 PM", end: "8:30 PM", type: "class", label: "Adult" },
      { day: "Friday", start: "10:00 AM", end: "12:00 PM", type: "class", label: "Adult" },
      { day: "Friday", start: "6:30 PM", end: "8:30 PM", type: "class", label: "Adult" },
      { day: "Saturday", start: "11:00 AM", end: "1:00 PM", type: "class", label: "Adult" },
      { day: "Sunday", start: "1:30 PM", end: "3:00 PM", type: "class", label: "Adult" },
    ],
    notes: "Judo only — Juniors (under 13) classes excluded. No instructor names listed on site. Address also appears as \"584 Saratoga Road\" on some pages — same location.",
    verified: "Aug 2026",
  },
  // ---- Central NJ ----
  {
...
const TOURNAMENTS = [
  ...
  },
  {
    ...
    date: "2026-10-03",
    location: "Denver, CO",
    description: "USA Judo sanctioned event at the Denver Buddhist Temple.",
    sourceUrl: "https://smoothcomp.com/sr_RS/event/34272",
  },
  {
